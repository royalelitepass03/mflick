          ...
          <div className="bg-[#08090D] border border-[#242832] rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <section>
              ...
              <div className="flex items-center gap-4 mb-4">
                <img src="https://i.pravatar.cc/150?img=12" alt="Profile" className="w-16 h-16 rounded-full ring-2 ring-[#242832] object-cover" />
                <div>
                  <p className="font-bold text-[#F0F2F5]">Alex Rivera</p>
                  <p className="text-sm text-[#8A9099]">@arivera</p>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div><label className="text-xs text-[#8A9099] uppercase tracking-wider block mb-1">Username</label><input defaultValue="@arivera" className="w-full px-3 py-2 rounded-lg bg-[#101217] border border-[#242832] text-sm text-[#F0F2F5] outline-none focus:border-[#E8A93F]/60" /></div>
                <div><label className="text-xs text-[#8A9099] uppercase tracking-wider block mb-1">Email</label><input defaultValue="alex@example.com" className="w-full px-3 py-2 rounded-lg bg-[#101217] border border-[#242832] text-sm text-[#F0F2F5] outline-none focus:border-[#E8A93F]/60" /></div>
                <div><label className="text-xs text-[#8A9099] uppercase tracking-wider block mb-1">Birthdate</label><input defaultValue="1995-03-12" type="date" className="w-full px-3 py-2 rounded-lg bg-[#101217] border border-[#242832] text-sm text-[#F0F2F5] outline-none focus:border-[#E8A93F]/60" /></div>
                <div><label className="text-xs text-[#8A9099] uppercase tracking-wider block mb-1">Display Name</label><input defaultValue="Alex Rivera" className="w-full px-3 py-2 rounded-lg bg-[#101217] border border-[#242832] text-sm text-[#F0F2F5] outline-none focus:border-[#E8A93F]/60" /></div>
              </div>
            </section>
